...
public class Main {
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            tabbedPane.addTab("Student Management", new StudentPanel(studentManager));
            tabbedPane.addTab("Course Management", new CoursePanel(courseManager));
            tabbedPane.addTab("Enrollment Management", new EnrollmentPanel(enrollmentManager, studentManager, courseManager));
